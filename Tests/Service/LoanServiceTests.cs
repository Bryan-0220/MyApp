...
namespace Tests
{
    public class LoanServiceTests
    {
        ...
        public async Task EnsureNoDuplicateLoan_ShouldThrow_WhenLoanExists()
        {
            ...
            A.CallTo(() => repo.Filter(A<Application.Filters.LoanFilter>._, A<CancellationToken>._))
        ...
        public async Task EnsureNoDuplicateLoan_ShouldSucceed_WhenNoLoan()
        {
            ...
            // verify Filter was called with matching filter
            A.CallTo(() => repo.Filter(A<Application.Filters.LoanFilter>.That.Matches(f => f.BookId == "b1" && f.UserId == "r1"), A<CancellationToken>._)).MustHaveHappenedOnceExactly();
        }
        ...
        public async Task CreateLoan_ShouldCreate_WhenValid()
        {
            ...
            A.CallTo(() => repo.Filter(A<Application.Filters.LoanFilter>._, A<CancellationToken>._)).Returns(new List<Loan>());
        ...
        public async Task CreateLoan_ShouldThrow_WhenBusinessRuleFails(System.Type exceptionType)
        {
            ...
            if (exceptionType == typeof(NotFoundException))
                ...
                A.CallTo(() => repo.Filter(A<Application.Filters.LoanFilter>._, A<CancellationToken>._)).Returns(new[] { new Loan() });
        ...
        public async Task UpdateLoan_ShouldUpdate_WhenExists()
        {
            ...
            var service = new LoanService(repo, bookService, readerService);
            var input = new UpdateLoan.UpdateLoanCommandInput { Id = "l1", BookId = "b2" };
        ...
        public async Task UpdateLoan_ShouldThrowNotFound_WhenMissing()
        {
            ...
            var service = new LoanService(repo, bookService, readerService);
            var input = new UpdateLoan.UpdateLoanCommandInput { Id = "l2", BookId = "b2" };
        ...
        public async Task DeleteLoan_ShouldReturnFail_WhenRestoreCopiesFails()
        {
            ...
            // Loan is a real instance and CanBeDeleted is non-virtual; use its real behavior.
            ...
            // ensure delete was not attempted when restore failed
